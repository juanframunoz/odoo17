...
SOURCE_SPECS=(
    ...
    "fd-core|git@github-odoo-apps:juanframunoz/odoo-apps.git|17.0|fd_albaranes_compra_ai,fd_booking,fd_ocr_facturas_de_compra,whatsapp_mail_messaging,fd_vehicle_maintenance_reminders"
    ...
    "fd-finished|git@github-terminados:juanframunoz/terminados.git|main|fd_sugerencias_recambios_rapidapi,sale_ai_assistant,sale_chapaypintura,sale_reception_flow,sale_reception_flow_v1"
...
declare -A EXPECTED_MINIMUMS=(
    ...
    [whatsapp_mail_messaging]="17.0.1.1.4"
    [fd_vehicle_maintenance_reminders]="17.0.1.1.0"
