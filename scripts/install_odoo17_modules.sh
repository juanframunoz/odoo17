...
install_group "purchase-ocr"     "fd_albaranes_compra_ai,fd_ocr_albaranes_de_compra,fd_ocr_facturas_de_compra,fd_facturas_albaranes_ai"
...
readonly EXPECTED_MODULES="account_tax_balance,auditlog,date_range,date_range_account,fd_activity_sidebar,fd_albaranes_compra_ai,fd_booking,fd_booking_mechanics,fd_booking_voice_ai,fd_booking_workshop,fd_facturas_albaranes_ai,fd_ocr_albaranes_de_compra,fd_ocr_facturas_de_compra,fd_sale_multi_offer,fd_sugerencias_recambios_rapidapi,fd_whatsapp,fd_workshop_time_control,l10n_es_aeat,l10n_es_aeat_mod111,l10n_es_aeat_mod115,l10n_es_aeat_mod130,l10n_es_aeat_mod190,l10n_es_aeat_mod303,l10n_es_aeat_mod347,l10n_es_aeat_mod390,muk_web_appsbar,muk_web_chatter,muk_web_colors,muk_web_dialog,muk_web_theme,resource_booking,sale_ai_assistant,sale_chapaypintura,sale_reception_flow,sale_reception_flow_v1,web_calendar_slot_duration"
